  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        body: ["Inter-Regular", "serif"],
        "body-semi": ["Inter-SemiBold", "serif"],
        "body-bold": ["Inter-Bold", "serif"],
        caption: ["Inter-Regular", "serif"],
        "caption-semi": ["Inter-SemiBold", "serif"],
        "caption-bold": ["Inter-Bold", "serif"],
        hairline: ["Inter-Bold", "serif"],
        button: ["Inter-Medium", "serif"],
      },
      fontSize: {
